...
{
	enum class QueryParam : ABI_enum
	{
		ALLOCATION_UNIT,
		PROTECTION_UNIT,
		COMMIT_UNIT,
	...
	static const UShort DST_ALLOCATE = 0x08;
	static const UShort SRC_DECOMMIT = 0x10;
	static const UShort SRC_RELEASE = 0x30;
...
NIRVANA_BRIDGE_BEGIN (::Nirvana::Memory, NIRVANA_REPOSITORY_ID ("Memory"))
	...
	::Nirvana::UIntPtr (*query) (Bridge <::Nirvana::Memory>*, ::Nirvana::ConstPointer p, Type <Definitions < ::Nirvana::Memory>::QueryParam>::ABI_in param, Interface*);
NIRVANA_BRIDGE_END ()
...
public:
	...
	::Nirvana::UIntPtr query (::Nirvana::ConstPointer p, Type <Definitions < ::Nirvana::Memory>::QueryParam>::C_in param);
};
...
template <class T>
::Nirvana::UIntPtr Client <T, ::Nirvana::Memory>::query (::Nirvana::ConstPointer p, Type <Definitions < ::Nirvana::Memory>::QueryParam>::C_in param)
{
	Environment _env;
	Bridge < ::Nirvana::Memory>& _b (T::_get_bridge (_env));
