...
intmax_t __cdecl strtoimax (const char* restrict nptr,
                            char** restrict endptr, int base);
uintmax_t __cdecl strtoumax (const char* restrict nptr,
			     char** restrict endptr, int base);

intmax_t __cdecl wcstoimax (const wchar_t* restrict nptr,
                            wchar_t** restrict endptr, int base);
uintmax_t __cdecl wcstoumax (const wchar_t* restrict nptr,
			     wchar_t** restrict endptr, int base);
