...
#define NIRVANA_STD_BEGIN11 _LIBCPP_BEGIN_NAMESPACE_STD
#define NIRVANA_STD_END11 _LIBCPP_END_NAMESPACE_STD
#elif (__GLIBCXX__ )
#define NIRVANA_STD_BEGIN namespace std {
#define NIRVANA_STD_END }
#define NIRVANA_STD_BEGIN11 namespace std { inline namespace __cxx11 {
#define NIRVANA_STD_END11 }}
#else
#define NIRVANA_STD_BEGIN namespace std {
#define NIRVANA_STD_END }
#define NIRVANA_STD_BEGIN11 namespace std {
#define NIRVANA_STD_END11 }
#endif
