...
#define NIRVANA_STATIC_EXP_LIST(ids) extern "C" const void* NIRVANA_STATIC_EXP_LIST_ID(ids) = &BOOST_PP_LIST_FOLD_LEFT(NIRVANA_STATIC_CAT_NS, , ids)::export_struct_;\
