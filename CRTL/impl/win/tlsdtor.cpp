...
static _THREAD_LOCAL TlsDtorNode *dtor_list;
static _THREAD_LOCAL TlsDtorNode dtor_list_head;
...
extern const PIMAGE_TLS_CALLBACK __dyn_tls_dtor_callback = __dyn_tls_dtor;
