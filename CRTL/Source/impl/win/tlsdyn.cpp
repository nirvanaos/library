 ...
 */
_THREAD_LOCAL bool __tls_guard = false;
...
#ifdef _MSC_VER
extern "C" _CRTALLOC (".CRT$XLC") const PIMAGE_TLS_CALLBACK __xl_c = __dyn_tls_init;
NIRVANA_LINK_SYMBOL (__xl_c)
#else
static _CRTALLOC (".CRT$XLC") const PIMAGE_TLS_CALLBACK __attribute__ ((used)) __xl_c = __dyn_tls_init;
#endif
